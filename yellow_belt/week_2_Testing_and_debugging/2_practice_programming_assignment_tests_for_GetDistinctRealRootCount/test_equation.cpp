...
void TestOneRoot() {
    ...
    AssertEqual(GetDistinctRealRootCount(0, 1000, 0), 1);
...
int main() {
    TestRunner runner;
    runner.RunTest(TestZeroRoots, "Test zero roots");
    runner.RunTest(TestOneRoot, "Zero one root");
    runner.RunTest(TestTwoRoots, "Zero two roots");
